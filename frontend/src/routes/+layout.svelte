...
<div class="min-h-screen flex flex-col">
	...
	<footer class="bg-gray-100 border-t border-gray-200 text-gray-600">
		<div class="container mx-auto px-4 py-12">
			<div class="grid grid-cols-2 md:grid-cols-4 gap-8">
				...
				<div>
					...
					<ul class="space-y-2">
						...
						<li>
							<a
								href="https://github.com/alvinsga/mergenetwork/blob/main/move/sources"
								class="hover:text-purple-600">Contracts</a
							>
						</li>
					</ul>
				</div>
			...
			>
				<p>&copy; 2024 Merge Protocol. All rights reserved.</p>
				<div class="mt-4 md:mt-0 flex space-x-4">
					...
					<a
						href="https://github.com/alvinsga/mergenetwork"
						target="_blank"
